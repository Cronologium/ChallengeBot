from backend.game_v2.playbox.abstract.coordinate import Coordinate
from backend.game_v2.playbox.boards.g001_battleshipsBoard import BattleshipsBoard
from backend.game_v2.player import Player


class BattleshipPlayer(Player):
    def __init__(self, name, timeout, port):
        super(BattleshipPlayer, self).__init__(name, timeout, port)
