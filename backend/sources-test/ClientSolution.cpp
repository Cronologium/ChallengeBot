...
std::vector<unsigned char> ClientSolution::putShip(std::vector<unsigned char>& inBuffer)
{
	inBuffer;
...
std::vector<unsigned char> ClientSolution::shoot(std::vector<unsigned char>& inBuffer)
{
	inBuffer;
...
void ClientSolution::createShips()
{
